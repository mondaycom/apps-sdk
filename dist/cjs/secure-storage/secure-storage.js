            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if ((_a = result.data) === null || _a === void 0 ? void 0 : _a[secure_storage_consts_1.MONDAY_CODE_RESERVED_PRIMITIVES_KEY]) {
                            return [2 /*return*/, result.data[secure_storage_consts_1.MONDAY_CODE_RESERVED_PRIMITIVES_KEY]];
                        }
                        return [2 /*return*/, result.data];
                }
            });
