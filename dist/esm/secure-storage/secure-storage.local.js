...
import { decrypt, encrypt } from '../utils/cipher.js';
import { initDb } from '../utils/local-db.js';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        stringifiedValue = decrypt(encryptedValue);
                        valueAsObject = JSON.parse(stringifiedValue);
                        if ((valueAsObject === null || valueAsObject === void 0 ? void 0 : valueAsObject[MONDAY_CODE_RESERVED_PRIMITIVES_KEY]) !== undefined) {
                            return [2 /*return*/, valueAsObject[MONDAY_CODE_RESERVED_PRIMITIVES_KEY]];
                        }
    ...
    LocalSecureStorage.prototype.set = function (key, value) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        valueAsObject = isObject(value) ? value : (_a = {}, _a[MONDAY_CODE_RESERVED_PRIMITIVES_KEY] = value, _a);
                        validateKey(key);
                        stringifiedValue = JSON.stringify(valueAsObject);
                        encryptedValue = encrypt(stringifiedValue);
