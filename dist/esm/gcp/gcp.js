...
import { GCP_SCOPES } from '../types/gcp.js';
...
export var getGcpIdentityToken = function (identityToken) { return __awaiter(void 0, void 0, void 0, function () {
    var tokenClaims, tokenExpiration, now, nowInMilliseconds;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!!isDefined(identityToken)) return [3 /*break*/, 2];
                return [4 /*yield*/, generateGcpIdentityToken()];
            case 1: return [2 /*return*/, _a.sent()];
            case 2:
                tokenClaims = jwt.decode(identityToken);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, fetch(jwtSigningUrl, {
                        method: 'POST',
